# User Manual: Validating Existing Protocol V3.0 Projects

**Use Case**: Check status and validate an existing Protocol V3.0 agent build  
...
Quick reference for checking the status and health of an existing Protocol V3.0 project. Each phase has a validation prompt you can copy-paste.
...
```
Check overall Protocol V3.0 project status:
...
2. Verify project structure exists:
   - content-raw/ folder
   - dual-helix-3tracks-startup-v3/ folder
...
1. Check if dual-helix-3tracks-startup-v3/outputs/phase-01.md exists
...
1. Check if dual-helix-3tracks-startup-v3/outputs/phase-02.md exists
2. If exists, verify it contains:
...
1. Check if dual-helix-3tracks-startup-v3/outputs/phase-03.md exists
...
1. Check if dual-helix-3tracks-startup-v3/outputs/phase-04.md exists
...
3. Run graph validation:
   python dual-helix-3tracks-startup-v3/builder-assets/scripts/validate_graphs.py
...
1. Check if dual-helix-3tracks-startup-v3/outputs/phase-05.md exists
...
1. Check if dual-helix-3tracks-startup-v3/outputs/phase-06.md exists
...
1. Check if dual-helix-3tracks-startup-v3/outputs/phase-07.md exists
...
1. Check if dual-helix-3tracks-startup-v3/outputs/phase-08.md exists
...
1. Read the phase instructions:
   @dual-helix-3tracks-startup-v3/phases/PHASE_0X_*.md
2. Read the output spec:
   @dual-helix-3tracks-startup-v3/specs/phase-0X-output.spec.md
3. Analyze what was actually created in that phase
4. Generate the phase-0X.md summary following the spec
5. Save to dual-helix-3tracks-startup-v3/outputs/phase-0X.md
```
...
```
Calculate Protocol V3.0 project health score:
