...
Run from repo root: python src/agentloom/kg/bootstrap_builder_kg.py
"""
...
BEHAVIOR_NODES = [
    ...
    },
    {
        ...
        "parent": "behavior:builder:root",
        "links": {
            "validator": ["src/agentloom/validators/every_behavior_declares_tier.py"],
            "related": ["behavior:builder:every-non-soft-behavior-has-validator"],
            "uses": [
                "knowledge:builder:governance-tiers",
            ],
    ...
    },
    {
        ...
        "parent": "behavior:builder:root",
        "links": {
            "validator": ["src/agentloom/validators/every_non_soft_behavior_has_validator.py"],
            "related": [
    ...
    },
    {
        ...
        "parent": "behavior:builder:root",
        "links": {
            "validator": ["src/agentloom/validators/kg_node_ids_are_unique.py"],
            "uses": [
                "knowledge:builder:kg-node-schema",
            ],
        },
...
def main() -> int:
    ...
    print("Next: run `python src/agentloom/kg/validate_all.py` and the per-behavior "
          "validators in src/agentloom/validators/.")
    return 0
