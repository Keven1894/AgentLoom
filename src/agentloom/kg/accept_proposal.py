...
Usage:
    python src/agentloom/kg/accept_proposal.py --proposal 20260518-141500-time-format-conventions.json

    # dry-run: show what would happen, don't write
    python src/agentloom/kg/accept_proposal.py --proposal <file> --dry-run
    ...
    python src/agentloom/kg/accept_proposal.py --proposal <file> --reject "<reason>"
"""
...
SCRIPTS_KG = Path(__file__).resolve().parent
SCRIPTS_VALIDATORS = Path(__file__).resolve().parent.parent / "validators"
