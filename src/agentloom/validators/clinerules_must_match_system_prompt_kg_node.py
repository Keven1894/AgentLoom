...
src/agentloom/sync_clinerules.py.
...
This validator delegates to src/agentloom/sync_clinerules.py --check, which:
...
SYNC_SCRIPT = Path(__file__).resolve().parent.parent / "sync_clinerules.py"
